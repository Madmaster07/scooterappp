 ...
 *
 * @property \App\Model\Table\MetodoDePagoTable $MetodoDePago
 */
class MetodoDePagoController extends AppController
{
    ...
    {
        $metodoDePago = $this->MetodoDePago->get($id, contain: ['Users']);
        $this->set(compact('metodoDePago'));
    }
    ...
    public function add()
    {
        ...
        $users = $this->MetodoDePago->Users->find('list', limit: 200)->all();
